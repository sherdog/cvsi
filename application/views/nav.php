 ...
 <!-- Top nav container -->
    ...
    <div class=" topnav-right">
        <a href="#" class="highlight"><?php echo img('images/headerTopIconGetQuote.png'); ?> Get a quote</a> <a href="tel:319-266-2687"> <?php echo img('images/headerTopIconCall.png'); ?> 319-266-2687</a> <a href="<?php echo $this->config->item('facebook_url'); ?>" target="_blank"><?php echo img('images/headerTopIconFacebook.png'); ?><a/> <a href="<?php echo $this->config->item('twitter_url'); ?>" target="_blank"><?php echo img('images/headerTopIconTwitter.png'); ?></a>
    </div>
    <!-- ./container navtop -->
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <div class="navbar-brand navbar-brand-centered"><a href="#"><?php echo img('images/headerLogo.png', 'class="img-responsive"'); ?></a></div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-brand-centered">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<?php echo site_url() . 'page/cvsi-gear'; ?>">CVSi Gear</a></li>
