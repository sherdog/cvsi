 ...
 */
    ...
    public function getPath($separator = ' - ') {
      ...
      foreach ( $this->_path as $entry ) {
        ...
        if ( !empty($entry['link']) ) {
          $trail_string .= "<a href=\"".$entry['link']."\" class=\"trail\" title=\"".$entry['title']."\">".$entry['title']."</a>";
		  //osc_link_object($entry['link'], $entry['title']);
        } else {
          $trail_string .= "<span class=\"trail\">".$entry['title']."</span>";
        }
