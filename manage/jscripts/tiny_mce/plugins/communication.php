...
if(isset($_POST['action'])) {
	...
	case 'savetemplate':
					//save the template!!!!
							...
							$row['email_templates_header'] = input($_POST['headerCode']);
							$row['email_templates_footer'] = input($_POST['footerCode']);
...
<?
if($_GET['section'] == 'compose_email' || $_GET['action'] == 'new') {
?>
...
$('#addToQueue').click( function() {
		...
		if($('#email_template').val() == "") {
			alert('doh! Select a template');
			return false;
		}
		
		if($('#subscribers:checked').val()!=null && $('#emailList').val() == "") {
			alert("doh! Make sure you select some recipients");
			return false;
		}
});
                                ...
                                <div class="mb20"></div>
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="5">
                                    <tr>
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                        <tr>
                                          <td class="pageTitleSub">Template Name</td>
                                        </tr>
                                        <tr>
                                          <td><input type="text" name="title" id="title" class="textField-title" style="width:650px" value="<?=output($tInfo['email_templates_name'])?>" /></td>
                                        </tr>
                                        <tr>
                                          <td class="pageTitleSub">Header HTML Code</td>
                                        </tr>
                                        <tr>
                                          <td><textarea name="headerCode" id="headerCode" style="width:650px;"  class="mceEditor" rows="5"><?=output($tInfo['email_templates_header'])?></textarea></td>
                                        </tr>
                                        <tr>
                                          <td class="pageTitleSub">Footer HTML Code</td>
                                        </tr>
                                        <tr>
                                          <td><textarea name="footerCode" id="content4" cols="45" style="width:650px;"  rows="5"><?=output($tInfo['email_templates_footer'])?></textarea></td>
                                        </tr>
                                      </table></td>
                                    </tr>
                                  </table>
							  ...
							  <tr>
                                ...
                                <div class="mb20"></div>
								  ...
								  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                    ...
                                    <ul>
                                      	<li><a href="#" onclick="tinymce.activeEditor.formatter.apply('heading_text');return false;">[Heading]</a></li>
                                        <li><a href="#" onclick="tinymce.activeEditor.formatter.apply('subheading_text');return false;">[Subheading]</a></li>
                                        <li><a href="#" onclick="tinymce.activeEditor.formatter.apply('reg_text');return false;">[Paragraph]</a></li>
                                      </ul>
                                      </div>
                                      </td>
								    </tr>
...
default:
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							  <tr>
								<td valign="top" class="formBody">
                                <div class="mb20"></div>
								<h2>Pending Communiqu&eacute;</h2>
								  ...
								  <div class="mb20"></div>
								  <h2>Archived Communiqu&eacute;</h2>
									<?
